...
# Build the firmware
build_dongle() {
  build_target "${KEYBOARD}_dongle"
}

build_dongle_oled() {
  build_target "${KEYBOARD}_dongle_oled"
}

build_left() {
  build_target "${KEYBOARD}_left"
}

build_right() {
  build_target "${KEYBOARD}_right"
}
...
Commands:
  ...
  build_dongle_oled Build central dongle with OLED firmware
...
Examples:
  ...
  $0 build_dongle_oled                          # Build central dongle with OLED
